...
namespace PeopleApp.Models.Repos
{
    public class DatabasePeopleRepo : IPeopleRepo
    {
        ...
        {
            return _peopleAppDbContext.Person.Include(person => person.City).ToList();
        }

        public Person Read(int id)
        {
            return _peopleAppDbContext.Person.Include(person => person.City).SingleOrDefault(person => person.Id == id);
        }
